...
import { Loan, AppliedStrategy } from '../loans/types';
import { generateAmortizationSchedule, formatCurrency, calculateDebtSummary } from '../loans/calculations';
import { optimizeDebtPayoff } from './debtOptimizer';
