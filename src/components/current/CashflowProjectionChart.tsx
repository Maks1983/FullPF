...
const CashflowProjectionChart: React.FC<CashflowProjectionChartProps> = ({
  ...
  const pathData = projections.map((proj, index) => {
      ...
      <div className="grid grid-cols-3 gap-4 pt-4 border-t">
        <div className="text-center">
          <p className="text-lg font-bold text-gray-900">
            NOK {projections[0].projectedBalance.toLocaleString()}
          </p>
        ...
        <div className="text-center">
          <p className="text-lg font-bold text-gray-900">
            NOK {projections[projections.length - 1].projectedBalance.toLocaleString()}
          </p>
